...
export function ConsentPage() {
  ...
  function shareMessage() {
    ...
    return `Hola ${name}, te compartimos de EMT Medical Group el formulario de Consentimiento Informado para tu tratamiento de TMS. Descárgalo aquí y tráelo firmado (o lo firmamos en la clínica) el día de tu evaluación.`
  }
